            ...
            <table class="table table-sm table-striped table-bordered mt-4">
                <thead class="table-primary">
                    <tr>
                        ...
                        <th style="width: 30%">Documento de la persona</th>
                        <th style="width: 30%">Nombre de la persona</th>
                ...
                <tbody>
                    ...
                    foreach ($filas as $indice => $columnas) {
                        echo "<tr>";
                        echo "<td>{$columnas["idPerson"]}</td>";
                        echo "<td>{$columnas["documentPerson"]}</td>";
                        echo "<td>{$columnas["name"]}</td>";
                        echo "<td>{$columnas["nomRol"]}</td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
