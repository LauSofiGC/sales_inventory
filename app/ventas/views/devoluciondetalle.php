...
$filas = $objeto->getDevolucionIds($codFac);
$precioTot = $objeto->getTotalDev($codFac);
?>
<html>
    <head>
        <meta charset="UTF-8">
        ...
        <section class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Crear devolución</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Devolución detalle</li>
                </ol>
            </nav>
            ...
            <h4>Devolución total: 
                <span class="badge badge-pill badge-primary">
                    <?php
                    $precioFormateado = number_format($precioTot);
