...
$filas = $objeto->getDevolucionesAprobadas();
        ...
        <section class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Devoluciones aprobadas</li>
                </ol>
            </nav>
                    <h4>Devoluciones: 
                <span class="badge badge-pill badge-primary">
                    <?php
                    echo "Devoluciones aprobadas";
                    ?>
                </span>
            </h4>
            <?php
            if ($cantidadRegistros > 0) {
                ...
                <div class="alert alert-warning"> 
                    No existen devoluciones aprobadas
                </div>
                <?php
            }
            ?>
