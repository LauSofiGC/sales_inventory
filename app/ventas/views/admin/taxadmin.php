...
$objeto = new taxcontroller();
$filas = $objeto->getAllTax();
...
<html>
    <head>
     ...
     <link href="../../../../vendor/tws/bootstrap-4.4.1/dist/css/bootstrap.css" rel="stylesheet" type="text/css"/>
        ...
        <script src="../js/taxborrar.js" type="text/javascript"></script>
    </head>
    <body>
            ...
            <table class="table table-sm table-striped table-bordered">
                <thead class="table-primary">
                    <tr>
                        ...
                        <th style="width: 64%">Nombre Impuesto</th>
                ...
                <tbody>
                    ...
                    foreach ($filas as $indice => $columnas) {
                        $codigo = $columnas["idTax"];
                        $nombre = $columnas["taxName"];
                        $cantidad = $columnas["cantidad"];

                        $cantidadProductos = $columnas["cantidad"];
                        if ($cantidadProductos == 0) {
                            $iconoBorrar = "<a title=\"Borrar Impuesto\" "
                        ...
                        echo "{$iconoBorrar}&nbsp;";
                        echo "<a title=\"Editar división\" href=\"taxeditar.php?cod={$codigo}\">";
