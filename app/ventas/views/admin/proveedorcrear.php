...
$rolObj = new proveedorcontroller();
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <section class="container">
            ...
            <div class="card">
                <div class="card-header">
                    Formulario creación de proveedor
                </div>
                <div class="card-body">
                    <form name="miFormulario" id="miFormulario" method="post" action="../../controller/proveedorcontroller_crearpost.php">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Nombre proveedor</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="cajaNomPro" name="cajaNomPro" placeholder="Nombre proveedor"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Teléfono proveedor</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="cajaTelPro" name="cajaTelPro" placeholder="Teléfono"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary">Crear Proveedor</button>
                                <a href="proveedorlistar.php" class="btn btn-secondary">Cancelar</a>
                            </div>
                        </div>
                    </form> 
                </div>
