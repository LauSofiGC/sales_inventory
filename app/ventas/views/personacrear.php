...
use app\ventas\controller\rolcontroller;
use vendor\messages\notifications;
use vendor\form\dropdown;

$rolObj = new rolcontroller();
$todosRoles = $rolObj->getAllDropDown();
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <section class="container">
            ...
            <div class="card">
                <div class="card-header">
                    Formulario creación de persona
                </div>
                <div class="card-body">
                    <form name="miFormulario" id="miFormulario" method="post" action="../controller/personacontroller_crearpost.php">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Nombre del rol</label>
                            <div class="col-sm-4">
                                <?php
                                echo dropdown::show("cajaCodigoRol", $todosRoles, "form-control", "Selecciona un rol", "");
                                ?>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="email" class="form-control" id="cajaEmailPersona" name="cajaEmailPersona" placeholder="Email"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Contraseña</label>
                            <div class="col-sm-4">
                                <input type="password" class="form-control" id="cajaClave" name="cajaClave" placeholder="Contraseña"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-10">
